...
import com.example.android.architecture.blueprints.todoapp.taskdetail.FakeAndroidTestRepository
...
class TasksFragmentTest {
    ...
    fun clickTask_navigateToDetailFragmentOne() = runBlockingTest {
        repository.saveTask(task = Task("title1", "desc1", false, "id1"))
        repository.saveTask(task = Task("title2", "desc2", false, "id2"))
